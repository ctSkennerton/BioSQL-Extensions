        ...
        for l2,d2 in d1.items():
            ...
            for l3,d3 in d2.items():
                ...
                for l4, d4 in d3.items():
                    ...
                    l4_id = server.adaptor.execute_and_fetch_col0('select term_id from term where identifier = %s and ontology_id = %s', (l4, kegg_ontology))[0]
                    ...
                    for ortholog in d4['orthologs']:
                        ...
                        server.adaptor.execute('insert into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l1_id, predicate_id, ortho_id, kegg_ontology, 4))
                        server.adaptor.execute('insert into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l2_id, predicate_id, ortho_id, kegg_ontology, 3))
                        server.adaptor.execute('insert into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l3_id, predicate_id, ortho_id, kegg_ontology, 2))
