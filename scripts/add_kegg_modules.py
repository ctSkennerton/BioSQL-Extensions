...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--ontology', help='give a name for this ontology', default='KEGG_modules')
    ...
    if len(rows) == 0:
        server.adaptor.execute('insert into ontology (name, definition) values(%s, %s)', (args.ontology, 'The Kegg module ontology'))
    ...
    for l1,d1 in yaml_data.items():
        ...
        for l2,d2 in d1.items():
            ...
            for l3,d3 in d2.items():
                print '        -',l3
                server.adaptor.execute('insert into term (name, ontology_id) values (%s, %s)', (l3, kegg_ontology))
                ...
                for l4, d4 in d3.items():
                    if d4['orthologs'] is None:
                        continue

                    print '            -',l4,d4['definition']
                    server.adaptor.execute('insert into term (identifier, name, ontology_id) values (%s, %s, %s)', (l4, d4['definition'], kegg_ontology))
                    l4_id = server.adaptor.execute_and_fetch_col0('select term_id from term where name = %s and ontology_id = %s', (l4, kegg_ontology))[0]
                    server.adaptor.execute('insert into term_relationship (subject_term_id, predicate_term_id, object_term_id, ontology_id) values (%s, %s, %s, %s)', (l3_id, predicate_id, l4_id, kegg_ontology))
                    server.adaptor.execute('insert into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l1_id, predicate_id, l4_id, kegg_ontology, 3))
                    server.adaptor.execute('insert into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l2_id, predicate_id, l4_id, kegg_ontology, 2))
                    server.adaptor.execute('insert into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l3_id, predicate_id, l4_id, kegg_ontology, 1))


                    for ortholog in d4['orthologs']:
                        ...
                        server.adaptor.execute('insert into term_relationship (subject_term_id, predicate_term_id, object_term_id, ontology_id) values (%s, %s, %s, %s)', (l4_id, predicate_id, ortho_id, kegg_ontology))
                        server.adaptor.execute('insert or ignore into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l1_id, predicate_id, ortho_id, kegg_ontology, 4))
                        server.adaptor.execute('insert or ignore into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l2_id, predicate_id, ortho_id, kegg_ontology, 3))
                        server.adaptor.execute('insert or ignore into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l3_id, predicate_id, ortho_id, kegg_ontology, 2))
                        server.adaptor.execute('insert into term_path (subject_term_id, predicate_term_id, object_term_id, ontology_id, distance) values (%s,%s,%s,%s,%s)', (l4_id, predicate_id, ortho_id, kegg_ontology, 1))
